...
import { handleModuleDeployed as handleModuleDeployedV0_6_0 } from "../src/hatsModuleFactoryV0_6_0";
import { handleModuleDeployed as handleModuleDeployedV0_7_0 } from "../src/hatsModuleFactoryV0_7_0";
import {
  ...
  describe("With factory v0.6.0", () => {
    ...
    describe("And a MutliClaimsHatter is created without initial hats, and wears 0x00000001.0001", () => {
      beforeEach(() => {
        ...
        handleModuleDeployedV0_6_0(multiClaimsHatterCreatedEvent);
  ...
  describe("With factory v0.7.0", () => {
    ...
    describe("And a MutliClaimsHatter is created without initial hats, and wears 0x00000001.0001", () => {
      beforeEach(() => {
        ...
        handleModuleDeployedV0_7_0(multiClaimsHatterCreatedEvent);
